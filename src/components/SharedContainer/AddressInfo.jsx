  ...
  return (
    <>
      <ListGroup className="m-3">
        <ListGroupItem color="info">
          ...
          {props.edit === "true" && (
            <button
              ...
              onClick={() => togglePopup(!isModalPopupOpen)}
            >
              Change
            </button>
          )}
        ...
        <ListGroupItem>
          <strong>Email Id:</strong> {props.userAddressInfo.emailId}
        </ListGroupItem>
        <ListGroupItem>
          <strong>Phone Number:</strong> {props.userAddressInfo.phoneNumber}
        </ListGroupItem>
        <ListGroupItem>
          <strong>Street Address:</strong> {props.userAddressInfo.streetAddress}
        </ListGroupItem>
        <ListGroupItem>
          <strong>City: </strong>
          {props.userAddressInfo.city}{" "}
        </ListGroupItem>
        <ListGroupItem>
          <strong>State:  </strong> {props.userAddressInfo.state} Pincode:{" "}
          {props.userAddressInfo.pincode}
        </ListGroupItem>
        <ListGroupItem>
          <strong>Country:</strong> {props.userAddressInfo.country}
        </ListGroupItem>
      </ListGroup>
      ...
      <Modal
        ...
        toggle={() => togglePopup(!isModalPopupOpen)}
      >
        <ModalHeader toggle={() => togglePopup(!isModalPopupOpen)}>
          Address Information
        </ModalHeader>
