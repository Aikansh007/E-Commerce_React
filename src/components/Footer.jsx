      ...
      <div className="text-center container text-md-left">
        <div className=" row my-4">
          <div className="col-md-4 col-lg-4">
            ...
            <p>Here You can get all shopping material you are intereted in.</p>
            <p>
              Shops are necessary places, where people go to buy their necessary
              things. Shopping is something which is loved by all of us. It is
              said that many people find shopping relaxing. I too believe that
              shopping is a relaxing thing as whenever I get too stressed or
              tensed.
            </p>
          </div>
